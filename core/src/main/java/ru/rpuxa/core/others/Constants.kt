...
const val NO_PLAYER_COLOR_CELL = LIGHT_GRAY
const val NULL_COLOR_CELL = BLACK
const val BACKGROUND_FIELD_COLOR = BLACK
const val TERRITORY_COLOR_BOARD = YELLOW
const val UNIT_REGION_MOVE_BORDER_COLOR = BLUE
const val UNIT_REGION_ATTACK_BORDER_COLOR = RED
