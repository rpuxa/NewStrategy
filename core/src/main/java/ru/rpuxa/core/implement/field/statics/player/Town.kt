...
import ru.rpuxa.core.others.INITIAL_PERFORMANCE
import ru.rpuxa.core.others.TOWN_COUNT_PERFORMANCE_FACTOR
import ru.rpuxa.core.others.TOWN_LEVEL_PERFORMANCE_FACTOR
import ru.rpuxa.core.others.copyLocation
...
open class Town : PlayerBuilding {
    ...
    constructor(location: Location, owner: Player, id: Int, workPoints: Int,
