...
class Swordsman(location: Location, override val owner: Player) : FightingUnit() {
    ...
    constructor(location: Location, owner: Player, id: Int, health: Int, movePoints: Int) : this(location, owner) {
        super.id = id
        this.health = health
    ...
    override fun copy() = Swordsman(this.copyLocation(), owner, id, health, movePoints)
}